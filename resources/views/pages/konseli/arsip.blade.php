                                ...
                                <div class="d-flex align-items-center justify-content-between mb-5">
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-circle symbol-50 mr-3">
                                            <img class="img-fit" alt="Pic" src={{"/avatars/".$konseling->konselor->user->avatar}}>
                                        </div>
                                        <div class="d-flex flex-column">
                                            <a id={{"daftarkonseli__".$konseling->id}} href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-lg">{{$konseling->konselor->nama_konselor}}</a>
